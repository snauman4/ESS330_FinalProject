...
Water quality is an important environmental concern, especially in river systems that are affected by urbanization, rapid climate change, and stressors like pollution. These ecosystems provide crucial habitat for both aquatic and terrestrial organisms but remain vulnerable to anthropogenic activities, such as industrialization. This study explores how designated environmentally-protected areas affects the water quality of river systems in the U.S. Southwestern river basins. Using nearly 50 years of water quality data from U.S. Geologiclal Survey, we analyzed ten river sites using various statistical tests to assess long-term trends in daily streamflow, water temperature, and pH levels. Our results show that there are statistically significant differences between environmentally-protected and unprotected sites for all three variables. Overall, unprotected sites have higher mean flow, warmer temperatures, and more alkaline pH levels compared to protected sites. Time series decompositions and seasonal patterns further confirm annual cycles across all sites, with greater streamflow variability and some fluctuations at unprotected sites. These findings indicate that protection status is generally associated with both chemical and physical differences in U.S. Southwest river basins. However, environmental protections alone are not a gurantee for better water quality. Our work has highlighted the need for more funding and consistent monitoring at unprotected sites to improve overall site-level management in our watershed systems.
...
```
From each of the sites listed above and seen in Figure 1, we obtained daily measurements of streamflow in cubic feet per seconds, water temperature in celsius, and pH levels from the daily data tab on the USGS National Water Information System. In this step of our analysis we reached some issues regarding when data time frames were available, ultimately leading to our decision to have our temporal scope be set between 1975-10-01 (water year 1976) to 2024-10-01 (beginning of water year 2025). In addition to this, we decided to facilitate our analysis by coding our daily values– Flow (cfs), Water Temperature (°C), and pH– to be aggregated into monthly means to be able to observe seasonal variation and reduce short-term noise. All analyses were conducted using Rstudio for visualization, statistical analysis, and mapping into figures. Additionally, it was decided to standardize each site so that there is more of an apples-to-apples comparison with streamflow values. To do this, the streamflow values of each site were divided by the drainage area to get flow in cubic feet per second per mile squared, allowing for a direct comparison of flow characteristics across watersheds of different sizes. This process normalizes the flow data, making it easier to compare watersheds based on their flow intensity per unit area, irrespective of their size. 

To create decomposition graphs for easier visualization to create conclusions from the values, we imputed missing values in time series data is crucial for maintaining the integrity of the analysis; especially when gaps in the data could distort trends and seasonal patterns. In this study, linear interpolation was used to fill in missing values, assuming that the missing data points are reasonably close to adjacent observations. This ensures a complete dataset, allowing for accurate seasonal decomposition. STL Decomposition (Seasonal and Trend decomposition using Loess) was then applied to separate the time series into trend, seasonal, and residual components, which helps identify underlying patterns in the flow data. By isolating the seasonal effects, long-term trends, and random fluctuations, this method provides valuable insights into how flow changes over time. The imputation and decomposition steps enabled clearer visualization of seasonal patterns, such as annual flow cycles, and long-term trends, allowing for comparison between unprotected and protected sites. This approach not only improves the robustness of the analysis but also facilitates a deeper understanding of the environmental factors influencing the watersheds.
...
Seasonal subseries plots break down each site’s flow into monthly panels. Both the protected and unprotected sites reveal either a clear pulse each in the summer or the winter months, with median monthly flows peaking higher than in the other months, with relatively tight variability across years. Unprotected USGS sites 09034250 (Colorado River at Windy Gap near Granby, CO) and 09147500 (Uncompahgre River, Colona, CO), with large peaks in the summer months (Figure 3). Along with that, the unprotected USGS sites 9505800 (West Clear Creek near Camp Verde, AZ) and 1107400 (Santa Ana River below Prado Dam, CA) exhibited large peaks in the winter months. The protected sites corresponding to its unprotected site location exhibited the same seasonal trends (Figure 4).
...
Our results shows statistically significant differences in water quality through two of our indicators Water Temperature (°C), and pH levels between protected and unprotected river sites across the Southwest River Basin region, but our Flow (cfs) indicator does not support our hypothesis as it showed lower streamflow levels at protected sites vs unprotected sites. Despite the flow being lower, the p-value is still under 0.01 so overall we *reject our null hypothesis*. Our analysis have supported this finding as the three, one-way ANOVA tests that were conducted confirmed that protection status plays a statistically significant role in influencing these hydrological and chemical properties ( Flow: p < 2e-16; Water Temperature: p = 4.32e-15; pH = 1.1e-15). The second statistical test, the Welsh two-sample t-tests,  we conducted also supported this through showing that protected sites showed a slightly lower average flow (0.1539866 cfs) than unprotected sites (0.2705940 cfs), as unprotected sites typically had higher water temperatures averages (15.46°C) in comparison to protected sites (13.09°C), and slightly more alkaline conditions (pH 8.33 vs 8.01). These results suggest that protection status is associated with both chemical and physical differences in the Southwest River Basin systems. With that being said, it is also important to note that site-specific factors like elevation, local land, and drainage area contribute meaningful to variability as we saw in the Welch one-way test and Tukey HSD post-hoc tests that further confirmed that not all protected and unprotected sites are hydrologically equivalent. 
