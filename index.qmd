...
Seasonal subseries plots break down each site’s flow into monthly panels. Both the protected and unprotected sites reveal either a clear pulse each in the summer or the winter months, with median monthly flows peaking higher than in the other months, with relatively tight variability across years. Unprotected USGS sites 09034250 and 09147500, with large peaks in the summer months (Figure 3). Along with that, the unprotected USGS sites 9505800 and 1107400 exhibited large peaks in the winter months. The protected sites corresponding to its unprotected site location exhibited the same seasonal trends (Figure 4).
...
p_decomp_un_flow_imputed <- autoplot(decomp_unprotected_flow_imputed, level = NULL) +
  ...
  scale_color_manual(values = c("red", "blue", "green", "purple", "orange"), # Assign colors to each site_no
                     labels = c("09034250", "09147500", "11074000", "9315000", "9505800")) +  # Update legend with site numbers
  theme_minimal() +
  theme(legend.title = element_blank()) 

# Show the decomposition plot
print(p_decomp_un_flow_imputed)
...
p_decomp_pro_flow_imputed <- autoplot(decomp_protected_flow_imputed, level = NULL) +
  ...
  scale_color_manual(values = c("red", "blue", "green", "purple", "orange"), # Assign colors to each site_no
                     labels = c("06752260", "09163500", "11044000", "09510000", "09261000")) +  # Update legend with site numbers
  theme_minimal() +
  theme(legend.title = element_blank())

# Show the decomposition plot for protected sites
print(p_decomp_pro_flow_imputed)
