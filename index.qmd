...
```
Seasonal subseries plots break down each site’s flow into monthly panels. Both the protected and unprotected sites reveal either a clear pulse each in the summer or the winter months, with median monthly flows peaking higher than in the other months, with relatively tight variability across years. Unprotected USGS sites 09034250 and 09147500, with large peaks in the summer months. Along with that, the unprotected USGS sites 9505800 and 1107400 exhibited large peaks in the winter months. The protected sites corresponding to its unprotected site location exhibited the same seasonal trends.
...
```
The seasonal decomposition of flow data for both protected and unprotected sites shows distinct patterns across the four panels. In the top panel, the raw or observed data reveal considerable fluctuations in flow over time, with large spikes observed during spring and early summer months at both site categories. The second panel, which represents the trend component, highlights the overall long-term patterns of flow, illustrating gradual increases and decreases in flow that are likely influenced by broader climatic or environmental trends. In the third panel, the seasonal component captures the regular, repeating flow cycles, likely driven by seasonal changes such as snowmelt, precipitation patterns, and temperature fluctuations, with protected sites showing more uniform seasonal patterns. Lastly, the final panel, showing the remainder or residuals, captures the noise or random fluctuations that cannot be explained by the trend or seasonal cycles. These residuals demonstrate the unpredictable deviations from the expected seasonal flow, with the unprotected sites exhibiting greater variability in the flow compared to the more stable protected sites.
